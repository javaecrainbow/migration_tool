...
import org.flywaydb.core.internal.resolver.java.ScanningJavaUndoResolver;
import org.flywaydb.core.internal.resolver.sql.SqlUndoResolver;
 ...
 * resolvers.
 */
public class CompositeUndoMigrationResolver implements MigrationResolver {
    /**
    ...
    public CompositeUndoMigrationResolver(ResourceProvider resourceProvider,
        ...
        if (!configuration.isSkipDefaultResolvers()) {
            migrationResolvers.add(new SqlUndoResolver(resourceProvider, sqlScriptExecutorFactory, sqlScriptFactory,
                    configuration, parsingContext));
            migrationResolvers.add(new ScanningJavaUndoResolver(classProvider, configuration));
